...
exports.CamelModelMetadata = exports.CamelLanguageMetadata = exports.Languages = exports.CamelDataFormatMetadata = exports.DataFormats = exports.CamelMetadataApi = exports.PropertyMeta = exports.ElementMeta = void 0;
/**
 * Generated by karavan build tools - do NOT edit this file!
 */
var ElementMeta = /** @class */ (function () {
    function ElementMeta(name, className, title, description, labels, properties) {
        this.name = '';
        this.className = '';
        this.title = '';
        this.description = '';
...
var PropertyMeta = /** @class */ (function () {
    function PropertyMeta(name, displayName, description, type, enumVals, defaultValue, required, secret, isArray, isObject, label) {
        this.name = '';
        this.displayName = '';
        this.description = '';
        this.type = '';
...
var CamelMetadataApi = /** @class */ (function () {
    function CamelMetadataApi() {
    }
    CamelMetadataApi.getCamelModelMetadataByName = function (name) {
        return exports.CamelModelMetadata.find(function (value) { return value.name === name; });
    };
    CamelMetadataApi.getCamelModelMetadataByClassName = function (className) {
        return exports.CamelModelMetadata.find(function (value) { return value.className === className; });
    };
    CamelMetadataApi.getCamelDataFormatMetadataByName = function (name) {
        return exports.CamelDataFormatMetadata.find(function (value) { return value.name === name; });
    };
    CamelMetadataApi.getCamelDataFormatMetadataByClassName = function (className) {
        return exports.CamelDataFormatMetadata.find(function (value) { return value.className === className; });
    };
    CamelMetadataApi.getCamelLanguageMetadataByClassName = function (className) {
        return exports.CamelLanguageMetadata.find(function (value) { return value.className === className; });
    };
    CamelMetadataApi.getCamelLanguageMetadataByName = function (name) {
        return exports.CamelLanguageMetadata.find(function (value) { return value.name === name; });
    };
    CamelMetadataApi.getLanguage = function (name) {
        return exports.Languages.find(function (value) { return value[0] === name; });
    };
    CamelMetadataApi.hasLanguage = function (name) {
        return exports.Languages.filter(function (value) { return value[0] === name; }).length > 0;
    };
    return CamelMetadataApi;
}());
exports.CamelMetadataApi = CamelMetadataApi;
exports.DataFormats = [
...
exports.CamelDataFormatMetadata = [
